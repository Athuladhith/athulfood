...
const buildpath = path_1.default.join(dirname, '../build');
const app = (0, express_1.default)();
const PORT = 5000;
const server = http_1.default.createServer(app);

// CORS setup for frontend on Netlify and backend on Render
const corsOptions = {
    origin: ['https://brilliant-jelly-9b3a3d.netlify.app', 'https://athulfood-4.onrender.com'], // Allow both frontend origins
    methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    allowedHeaders: ['Content-Type', 'Authorization'],
    credentials: true  // Allow credentials (cookies, HTTP authentication, etc.)
};

app.use((0, cors_1.default)(corsOptions));  // Use the CORS middleware with the defined options

const io = new socket_io_1.Server(server, {
    cors: {
        origin: ['https://brilliant-jelly-9b3a3d.netlify.app', 'https://athulfood-4.onrender.com'],
        methods: ['GET', 'POST'],
        allowedHeaders: ['Content-Type', 'Authorization'],
        credentials: true  // Allow credentials for socket.io connections
    }
});
...
(0, db_1.default)()
    .then(() => {
        ...
        server.listen(PORT, () => {
            console.log(`Server running on https://athulfood-4.onrender.com`);
        });
    });
